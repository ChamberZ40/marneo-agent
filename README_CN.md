...
Marneo 把 AI 代理变成有名字、有项目意识的数字员工——可以在飞书/Lark 里工作，也可以从本地终端或浏览器运行，使用工具，记忆上下文，团队协作，始终在你的控制之下。

[![Python](https://img.shields.io/badge/Python-3.11+-blue)](https://python.org)
[![Status](https://img.shields.io/badge/status-active-FF6611)](#)
[![Local First](https://img.shields.io/badge/local--first-supported-00cc99)](#本地-onlyprivate-模式)
